...
Go to the **File Transcription** page on [interpretapp.ai](https://interpretapp.ai) and upload your file. Supported formats include:
...
[Upload a file and try it →](https://interpretapp.ai)
